...
public class SqoopOptions implements Cloneable {
	...
	@StoredAsProperty("db.query.prefix") private String prefix;
	@StoredAsProperty("db.query.suffix") private String suffix;
	@StoredAsProperty("db.query.usealias") private String useAlias;
	...
	public String getPrefixDecorated() {
	...
	public String getUseAlias() {
		return (this.useAlias==null ? "" : this.useAlias) ;
	}

	public String getSuffixDecorated() {
	...
	public String getSqlQueryRich() {
		return SubstitutionUtils.getOrElse(getPrefix()) + " " + getSqlQuery() + " " + SubstitutionUtils.getOrElse(getSuffix());
	}
